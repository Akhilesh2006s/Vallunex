...
const GlobalImpactSection = () => {
  return (
    <section
      id="global-impact"
      className="py-32 px-8 md:px-16 bg-white text-black"
    >
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="mt-10 grid grid-cols-2 gap-8">
            <div>
              <span className="font-display text-3xl text-black tabular-nums">
                5+
              </span>
          ...
          <a
            href="#"
            className="inline-block mt-10 border border-neutral-300 text-black px-8 py-3 text-sm hover:bg-black hover:text-white transition-colors duration-300"
          >
            Explore Our Impact
          </a>
        </motion.div>
